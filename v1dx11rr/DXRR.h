...
public:	
	...
	DXRR(HWND hWnd, int Ancho, int Alto)
	{
		...
		skydome = new SkyDome(32, 32, 100.0f, &d3dDevice, &d3dContext, L"Assets/Textures/skydomeYellow.jpg");
		//billboard = new BillboardRR(L"Assets/Billboards/fuego-anim.png", L"Assets/Billboards/fuego-anim-normal.png", d3dDevice, d3dContext, 5);
		model1 = new ModeloRR(d3dDevice, d3dContext, "Assets/Models/cabin/cabin.obj", L"Assets/Models/cabin/cabin.bmp", L"Assets/Models/cabin/cabin.bmp", 0, 0);
		model2 = new ModeloRR(d3dDevice, d3dContext, "Assets/Models/larva/larvaobj.obj", L"Assets/Models/larva/bicho_baseTexBaked.png", L"Assets/Cofre/Cofre-spec.png", 10, 0);
		//
		model3 = new ModeloRR(d3dDevice, d3dContext, "Assets/Models/bed/bed.obj", L"Assets/Models/bed/T_bed_BaseColor.jpg", L"Assets/Cofre/Cofre-spec.png", 15, 0);
		model4 = new ModeloRR(d3dDevice, d3dContext, "Assets/Models/monster/monstruoM2obj.obj", L"Assets/Models/monster/rgb.jpg", L"Assets/Cofre/Cofre-spec.png", 20, 0);
		model5 = new ModeloRR(d3dDevice, d3dContext, "Assets/Models/book/book.obj", L"Assets/Models/book/book.bmp", L"Assets/Cofre/Cofre-spec.png", 25, 0);
		model6 = new ModeloRR(d3dDevice, d3dContext, "Assets/Models/perro/perro.obj", L"Assets/Models/perro/Australian_Cattle_Dog_dif.jpg", L"Assets/Cofre/Cofre-spec.png", 30, 0);
		model7 = new ModeloRR(d3dDevice, d3dContext, "Assets/Models/radio/radio.obj", L"Assets/Models/radio/radio.png", L"Assets/Cofre/Cofre-spec.png", 35, 0);
		model8 = new ModeloRR(d3dDevice, d3dContext, "Assets/Models/rock/Rock.obj", L"Assets/Models/rock/Rock-Texture-Surface.jpg", L"Assets/Cofre/Cofre-spec.png", 40, 0);
		model9 = new ModeloRR(d3dDevice, d3dContext, "Assets/Models/tuberia/tuberia.obj", L"Assets/Models/tuberia/Rust Metal.png", L"Assets/Cofre/Cofre-spec.png", -10, 0);
		model10 = new ModeloRR(d3dDevice, d3dContext, "Assets/Models/walkie/Radio.obj", L"Assets/Models/walkie/Radio.bmp", L"Assets/Cofre/Cofre-spec.png", 50, 0);
	...
	void Render(void)
	{
		...
		camara->posCam.y = terreno->Superficie(camara->posCam.x, camara->posCam.z) + 1.7f;
		///////////
		...
		model1->Draw(camara->vista, camara->proyeccion, terreno->Superficie(0, 0), camara->posCam, 10.0f, 0, 'A', 1, false, false);
		model2->Draw(camara->vista, camara->proyeccion, terreno->Superficie(10, 0), camara->posCam, 10.0f, 0, 'A', 1, false, false);
		model3->Draw(camara->vista, camara->proyeccion, terreno->Superficie(15, 0), camara->posCam, 10.0f, 0, 'A', 1, false, false);
		model4->Draw(camara->vista, camara->proyeccion, terreno->Superficie(20, 0), camara->posCam, 10.0f, 0, 'A', 1, false, false);
		model5->Draw(camara->vista, camara->proyeccion, terreno->Superficie(25, 0) + 0.5f, camara->posCam, 10.0f, 0, 'A', 1, false, false);
		model6->Draw(camara->vista, camara->proyeccion, terreno->Superficie(30, 0), camara->posCam, 10.0f, 0, 'A', 1, false, false);
		model7->Draw(camara->vista, camara->proyeccion, terreno->Superficie(35, 0) + 0.5f, camara->posCam, 10.0f, 0, 'A', 1, false, false);
		model8->Draw(camara->vista, camara->proyeccion, terreno->Superficie(40, 0) + 1.0f, camara->posCam, 10.0f, 0, 'A', 1, false, false);
		model9->Draw(camara->vista, camara->proyeccion, terreno->Superficie(50, 0), camara->posCam, 10.0f, 0, 'A', 1, false, false);
		model10->Draw(camara->vista, camara->proyeccion, terreno->Superficie(55, 0), camara->posCam, 10.0f, 0, 'A', 1, false, false);
